...
const CreateRepostTextImagePostScreen = props => {
          ...
          <View style={styles.textareaWithBackground}>
            ...
            <View
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[0] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + IMAGE_BASE + props.route.params.item.asset[0] : "" }}
            ...
            <View
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[1] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + IMAGE_BASE + props.route.params.item.asset[1] : "" }}
              />
              <Image
                key="2"
                style={{
                ...
                source={{ uri: props.route.params.item.asset[2] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + IMAGE_BASE + props.route.params.item.asset[2] : "" }}
              />
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[3] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + IMAGE_BASE + props.route.params.item.asset[3] : "" }}
              />
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[4] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + IMAGE_BASE + props.route.params.item.asset[4] : "" }}
              />
...
export default CreateRepostTextImagePostScreen;