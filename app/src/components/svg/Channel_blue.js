...
const Channel_blue = props => {

  return (
    <>
      <Svg xmlns="http://www.w3.org/2000/svg" width="17.784" height="17.329" viewBox="0 0 17.784 17.329">
        <G id="Channel_Normal" transform="translate(-291.608 -228.836)">
