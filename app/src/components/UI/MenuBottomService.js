...
import Discover_Normal from '../../components/svg/Discover_Blue';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.box}>
          <TouchableOpacity
            ...
            <Image
              source={require('./images/service1.png')}
