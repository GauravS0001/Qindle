...
import PostActionsCommentsDetails from '../../components/post/PostActionsCommentsDetailsCommunity'
import { useNavigation } from '@react-navigation/native';
import CommentTextArea from '../../components/UI/CommentText';

const PostActionsCommentsCommunity = props => {
          ...
          <View style={{
          ...
          }}>
            {
              ...
              <TouchableOpacity
                ...
                <Text> {props.item.comments > 0 ? props.item.comments : 0} Comments</Text>
              </TouchableOpacity>
            }
...
export default PostActionsCommentsCommunity;
