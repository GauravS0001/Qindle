...
const CreatePostBottomSheetCommunity = props => {
  ...
  /*
   ...
   let post_array = [
    {
      icon: <Text_Post />,
      name: 'Create Text Post1',
      root: 'TextPostCommunity',
      navigate: 'TextPostCommunity',
    },
    //{
    //  icon: <Send_Postcard />,
    //  name: 'Send postcard (Direct message)'
    //},
    {
      icon: <Photo_Memory />,
      name: 'Upload Photo Memory',
      root: 'ImagePostCommunity',
      navigate: 'ImagePostCommunity',

    },
    {
      icon: <Video_Story />,
      name: 'Upload Video Story',
      root: 'VideoPostCommunity',
      navigate: 'VideoPostCommunity',
    },
    {
      icon: <Ask_Que />,
      name: 'Add Community',
...
export default CreatePostBottomSheetCommunity;
