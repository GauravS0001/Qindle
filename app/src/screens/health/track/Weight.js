...
const Weight = props => {
  ...
  const saveData = () => {
    ...
    props.saveUserMedicalData(formdata, 'weightinfo', props.type)
  }
          ...
          <ScrollView>
            <View style={{ flex: 12, flexDirection: "column", padding: 10 }}>
              ...
              <View style={{ flex: 1, marginTop: 20, flexDirection: "row", alignContent: "center", alignItems: "center", justifyContent: "center" }}>
                <Text style={{ fontSize: 16 }}>{value} Kg</Text>
              </View>
                  ...
                  renderItem={itemData => (
                    <>
                      <View style={{ flex: 1, flexDirection: 'row' }}>
                        ...
                        <Text style={{ flex: 1, fontSize: 14 }}>{itemData.item.weight} Kg</Text>
                      </View>
                    </>
                  )}
                />
