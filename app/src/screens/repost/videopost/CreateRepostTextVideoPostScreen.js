...
const CreateRepostTextVideoPostScreen = props => {
  ...
  const createPost = useCallback(ele => {
    ...
    setPostStatus(true);
    dispatch({
      type: types.CREATE_USER_POST_VIDEO,
      creatPost: creatPost,
    ...
    <>
      <BaseSafeAreaView style={{ backgroundColor: colors.white }}>
        <View style={{ flex: 1, marginHorizontal: 15 }}>
          ...
          <View style={styles.textareaWithBackground}>
            ...
            <View
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[0] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + '/' + props.route.params.item.screenshot_path[0] : "" }}
              />
            ...
            <View
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[1] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + '/' + props.route.params.item.screenshot_path[1] : "" }}
              />
              <Image
                key="2"
                style={{
                ...
                source={{ uri: props.route.params.item.asset[2] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + '/' + props.route.params.item.screenshot_path[2] : "" }}
              />
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[3] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + '/' + props.route.params.item.screenshot_path[3] : "" }}
              />
              ...
              <Image
                ...
                source={{ uri: props.route.params.item.asset[4] != undefined ? IMAGE_PROTOCOL + IMAGE_HOST + '/' + props.route.params.item.screenshot_path[4] : "" }}
              />
          ...
          <View style={{...styles.share_container, marginTop:40}}>
          ...
          <View style={styles.button_container}>
            {postStatus == false &&
              <TouchableOpacity
                ...
                <Text style={styles.continue_text}>POST VIDEO</Text>
              </TouchableOpacity>
            }
            {postStatus == true &&
              <TouchableOpacity
...
export default CreateRepostTextVideoPostScreen;