...
const TagCommunityBottomSheet = props => {
  ...
  const friends_array = useSelector(
    state => state.community.userCommunity,
  );
  ...
  /*
    const friends_array = [
      ...
      {key: 'Dominic', name: 'Dominic', status: false},
      {
        key: 'Jackson',
        name: 'Jackson',
        status: false,
        url: 'https://images.unsplash.com/photo-1497751770456-d8af337e01d6?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80',
      },
      {key: 'James', name: 'James', status: true},
      {
        key: 'Joel',
        name: 'Joel',
        status: false,
      ...
      {key: 'Jillian', name: 'Jillian', status: true},
      {
        key: 'Jimmy',
        name: 'Jimmy',
        status: false,
      ...
      {key: 'Julie', name: 'Julie', status: true},
      {key: 'Devin2', name: 'Devin', status: false},
      {
        key: 'Devin3',
        name: 'Devin',
        status: false,
      ...
      {key: 'Devin4', name: 'Devin', status: true},
      {key: 'Devin5', name: 'Devin', status: false},
      {
        key: 'Devin6',
        name: 'Devin',
        status: true,
        url: 'https://images.unsplash.com/photo-1489533119213-66a5cd877091?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=751&q=80',
      },
      {key: 'Devin7', name: 'Devin', status: false},
      {key: 'Devin8', name: 'Devin8', status: true},
    ];
  */
...
export default TagCommunityBottomSheet;
